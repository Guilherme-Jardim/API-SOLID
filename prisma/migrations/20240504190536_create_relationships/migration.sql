/*
  ...
  - You are about to drop the column `passwird_hash` on the `check_ins` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "check_ins" DROP COLUMN "passwird_hash",
